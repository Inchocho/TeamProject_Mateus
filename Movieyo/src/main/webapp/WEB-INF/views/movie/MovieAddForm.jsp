...
<body>
	...
	<div class="curPageDiv">
		...
		<div class="contContainer">
			<form action="./addCtr.do" method="post" id='submitForm' class="addForm" enctype="multipart/form-data">
				<div class="detailFormDiv">
					<div style="" class="detailForm_top">
						...
						<div style="width: 750px;">
							...
							<div class="movieInfo">
								<p class="p">국가</p>
								<input type="text" name='nation' id='nation' class="input">
							...
							<div class="movieInfo">
								<p class="p">상영시간</p>
								<input type="number" name='runtime' id='runtime' class="input">
					...
					<div class="detailForm_bottom" style="width: 891px;">
						<div class="movieInfo_area">
							...
							<textarea class="textarea" id="movieStoryArea"></textarea>
