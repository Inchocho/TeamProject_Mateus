...
<script>
        ...
        function q1() {
            ...
            $.ajax({
                type: "GET",
                url: "https://kobis.or.kr/kobisopenapi/webservice/rest/movie/searchMovieList.json?key=4d9071e4e172fb1139b7795df8163f19&movieNm=" + abcd,
                data: {},
...
<body>
	<!-- 당장 접속하는 링크가 없으므로 http://localhost:8079/Movieyo/movie/movie.do 직접입력으로 체크 -->	
    ...
    <div class="question-box">
        ...
        <button onclick="movieInfo()">업데이트3</button>           
        <table>
            <thead>
                <tr>
                    <td>영화제목</td>
