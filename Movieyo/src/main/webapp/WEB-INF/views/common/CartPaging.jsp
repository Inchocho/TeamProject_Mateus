...
<nav>
		<ul>
		<c:if test="${pagingMap.cartPaging.prevBlock ne 1}">
			<li>
				<a href="#" 
					onclick="goPageFnc(${pagingMap.cartPaging.prevBlock});">
					<span>«</span>
				</a>
			</li>
		</c:if>
		...
		<c:forEach var="num" 
			begin="${pagingMap.cartPaging.blockBegin}" 
			end="${pagingMap.cartPaging.blockEnd}">
		...
		<c:if test="${pagingMap.cartPaging.curBlock 
			< pagingMap.cartPaging.totBlock}">
			<li>
				<a href="#" 
					onclick="goPageFnc(${pagingMap.cartPaging.nextBlock});">
					<span>»</span>
				</a>
			</li>			
		</c:if>			
