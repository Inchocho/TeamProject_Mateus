	...
	<div class="userMpointDiv">
		...
		<table>
			<tr>
				...
				<td class="userMpointTd" id="userMpointView">10000</td>
<%-- 				${userMpointDto.mpoint} --%>
	...
	<form action='./chargeMpoint.do' method='post' id="chargeForm">
		<input id="beforeMpoint" type="hidden" value="10000">
		...
		<input id="afterMpoint" type="hidden">
	</form>
	<table>
			<tr>
				<td class="userMpointTd">충전후 Mpoint</td>
				<td class="userMpointTd" id="afterMpointView">0</td>
			</tr>
		</table>
	</div>
...
// 		var priceSum = parseInt(inputChargePointObj.value) + parseInt(price);
// 		inputChargePointObj.value = parseInt(priceSum);
// 	});
